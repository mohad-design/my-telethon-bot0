...
@Client.on_message(filters.command(["استيكر", "تحويل ملصق", "اضف ملصق"], ".") & filters.me)
async def kang(client: Client, message: Message):
    user = client.me
    replied = message.reply_to_message
    um = await message.edit_text("`جاري اضافه الاستيكر ⚡...`")
    media_ = None
    emoji_ = None
    is_anim = False
    is_video = False
    ...
    if replied and replied.media:
        ...
        await um.edit("**من فضلك قم بالرد علي الصوره او الملصق!**")
        return
    if media_:
        ...
        while True:
            ...
            if exist.set.count >= limit:
                ...
                await um.edit(
                    f"`انشاء حزمه جديده {pack} Because the Sticker Pack Is Full`"
                )
                continue
            break
        if exist is not False:
            ...
            while limit in await get_response(message, client):
                ...
                if await get_response(message, client) == "Invalid pack selected.":
                    ...
                    await asyncio.sleep(2)
                    await um.edit(
                        f"**تم اضافة الاستيكر بنجاح رابط الاستيكر!**\n         🔥 **[اضغط هنا ](https://t.me/addstickers/{packname})** 🔥\n**لاستخدام الاستيكر**"
                    )
                    return
            await client.send_document("stickers", media_)
            await asyncio.sleep(2)
            ...
            await um.edit("`انشاء حزمه جديده`")
            try:
                await client.send_message("Stickers", cmd)
            except YouBlockedUser:
                await client.unblock_user("stickers")
...
@Client.on_message(filters.command("بحث استيكر", ".") & filters.me)
