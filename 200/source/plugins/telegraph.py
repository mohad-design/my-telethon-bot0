...
@Client.on_message(filters.command(["تليجراف", "telegraph", "tm", "tgt"], ".") & filters.me)
async def uptotelegraph(client: Client, message: Message):
    ...
    if message.reply_to_message.media:
        ...
        try:
            ...
            return
        U_done = (
            f"**تم التحميل ** [Telegraph](https://telegra.ph/{media_url[0]})"
        )
        ...
        try:
            ...
            await tex.edit(f"**ERROR:** `{exc}`")
            return
        wow_graph = f"**تم الرفع** [Telegraph](https://telegra.ph/{response['path']})"
