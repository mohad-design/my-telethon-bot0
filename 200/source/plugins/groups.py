...
async def mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6751649015:
            return await msg.edit("✷ لا يمكنك كتم المبرمج النقيب")
        if msg.reply_to_message.from_user.id == 5993309733:
            return await msg.edit("✷ لا يمكنك كتم المطور النقيب")
...
async def un_mute(c, msg):
    ...
    try:
        ...
        if msg.reply_to_message.from_user.id == 6751649015:
            return await msg.edit("✷ لا يمكنك الغاء كتم النقيب")
...
async def bann(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5993309733:
        return await msg.edit("✷ لا يمكنك حظر النقيب")
    try:
...
async def un_ban(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5993309733:
        return await msg.edit("✷ لا يمكنك الغاء حظر النقيب")
    try:
...
async def mute_all(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5993309733:
        return await msg.edit("✷ لا يمكنك كتم النقيب")
    if msg.reply_to_message.from_user.id == 6751649015:
        return await msg.edit("✷ لا يمكنك كتم النقيب")
...
async def ban_all(c, msg):
    ...
    if msg.reply_to_message.from_user.id == 5993309733:
        return await msg.edit("✷ لا يمكنك حظر النقيب")
    if msg.reply_to_message.from_user.id == 6751649015:
        return await msg.edit("✷ لا يمكنك حظر مرات النقيب")
